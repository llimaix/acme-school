-- ============================================================
-- ACME SCHOOL - Dataset Académico de Prueba
-- Ejecutar como: acme_school
-- Tarea: T-009 (Julian)
-- Descripción: Datos suficientes para probar transacciones,
--   seguridad, rendimiento y DW
-- ============================================================
...
-- ==================== SECCIONES - PERIODO 2024-1 (10) ====================
INSERT INTO seccion (curso_id, docente_id, periodo_id, codigo_seccion, cupo_maximo, cupo_disponible, horario, aula) 
  VALUES (1, 1, 1, 'A', 30, 22, 'Lun-Mie 07:00-08:30', 'A-101');
INSERT INTO seccion (curso_id, docente_id, periodo_id, codigo_seccion, cupo_maximo, cupo_disponible, horario, aula) 
  VALUES (3, 2, 1, 'A', 25, 17, 'Mar-Jue 09:00-10:30', 'LAB-01');
INSERT INTO seccion (curso_id, docente_id, periodo_id, codigo_seccion, cupo_maximo, cupo_disponible, horario, aula) 
  VALUES (5, 3, 1, 'A', 30, 23, 'Lun-Mie 10:00-11:30', 'A-201');
INSERT INTO seccion (curso_id, docente_id, periodo_id, codigo_seccion, cupo_maximo, cupo_disponible, horario, aula) 
  VALUES (7, 4, 1, 'A', 25, 20, 'Mar-Jue 14:00-15:30', 'LAB-02');
INSERT INTO seccion (curso_id, docente_id, periodo_id, codigo_seccion, cupo_maximo, cupo_disponible, horario, aula) 
  VALUES (11, 8, 1, 'A', 35, 28, 'Vie 08:00-11:00', 'A-301');

-- ==================== SECCIONES - PERIODO 2024-2 (10) ====================
INSERT INTO seccion (curso_id, docente_id, periodo_id, codigo_seccion, cupo_maximo, cupo_disponible, horario, aula) 
  VALUES (2, 1, 2, 'A', 30, 21, 'Lun-Mie 07:00-08:30', 'A-101');
INSERT INTO seccion (curso_id, docente_id, periodo_id, codigo_seccion, cupo_maximo, cupo_disponible, horario, aula) 
  VALUES (4, 2, 2, 'A', 25, 16, 'Mar-Jue 09:00-10:30', 'LAB-01');
INSERT INTO seccion (curso_id, docente_id, periodo_id, codigo_seccion, cupo_maximo, cupo_disponible, horario, aula) 
  VALUES (6, 3, 2, 'A', 30, 22, 'Lun-Mie 10:00-11:30', 'A-201');
INSERT INTO seccion (curso_id, docente_id, periodo_id, codigo_seccion, cupo_maximo, cupo_disponible, horario, aula) 
  VALUES (8, 5, 2, 'A', 25, 18, 'Mar-Jue 14:00-15:30', 'A-202');
INSERT INTO seccion (curso_id, docente_id, periodo_id, codigo_seccion, cupo_maximo, cupo_disponible, horario, aula) 
  VALUES (9, 6, 2, 'A', 20, 14, 'Vie 08:00-11:00', 'LAB-03');
